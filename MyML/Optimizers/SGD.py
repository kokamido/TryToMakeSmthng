...
class SGDOptimizer(Optimizer):
    ...
    def update_node_parameters(self, graph_node: CalcGraph, loss: AbstractLoss, data: DataLoader) -> None:
        ...
        loss_grads = np.apply_along_axis(loss.calc_grads, -1, np.dstack((predicted_values, labels)))
